...
def main():
    # Header
    st.markdown('<div class="main-header">🛰 Satellite Image Classifier</div>', unsafe_allow_html=True)
    ...
    # Load model
    if not TF_AVAILABLE:
        st.error("⚠ TensorFlow is not available. Please check your deployment configuration.")
        st.markdown("""
